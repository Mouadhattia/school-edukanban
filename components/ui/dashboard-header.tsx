          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="icon">
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  className="w-60 rounded-2xl bg-white shadow-lg p-2"
                  side="bottom"
                  align="end"
                >
                  {/* Header */}
                  ...
                  {/* Items */}
                  <DropdownMenuItem
                    className="mt-2 px-4 py-2 rounded-lg cursor-pointer text-sm text-red-600 hover:bg-red-50 hover:text-red-700"
                    onClick={() => {
                      signOut();
                    }}
                  >
